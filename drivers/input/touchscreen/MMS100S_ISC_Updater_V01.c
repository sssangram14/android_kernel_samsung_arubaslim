...
#if defined(CONFIG_MACH_KYLEPLUS_CTC) || defined(CONFIG_MACH_KYLEPLUS_OPEN) || defined(CONFIG_MACH_INFINITE_DUOS_CTC) || defined(CONFIG_MACH_NEVIS3G) || defined(CONFIG_MACH_DELOS_DUOS_CTC)
...
#if 0 // defined(CONFIG_MACH_ARUBA_OPEN)
	return MRET_SUCCESS;
#endif
...
eMFSRet_t check_firmware_version(const unsigned char *_pBinary_Data)
{
	...
	setVersion = 3;	//temp Infinite firmware
#endif
