...
#if defined(CONFIG_MACH_ARUBA_CTC) || defined(CONFIG_MACH_ARUBA_OPEN) || defined(CONFIG_MACH_ARUBASLIM_OPEN) || defined(CONFIG_MACH_ROY) || defined(CONFIG_MACH_KYLEPLUS_OPEN)
...
#elif defined(CONFIG_MACH_ARUBA_OPEN) || defined(CONFIG_MACH_ARUBASLIM_OPEN) || defined(CONFIG_MACH_KYLEPLUS_OPEN)
#define TOTAL_CHARGING_TIME		(6 * TIME_UNIT_HOUR)
#define TOTAL_RECHARGING_TIME		(90 * TIME_UNIT_MINUTE)
#elif defined(CONFIG_MACH_ARUBA_CTC) || defined(CONFIG_MACH_ROY)|| defined(CONFIG_MACH_KYLEPLUS_CTC)
...
#define BATT_TEMP_LOW_RECOVER_LPM	0
#endif
#elif defined(CONFIG_MACH_ARUBA_CTC) || defined(CONFIG_MACH_ARUBA_OPEN) || defined(CONFIG_MACH_ARUBASLIM_OPEN) || defined(CONFIG_MACH_ROY) || defined(CONFIG_MACH_KYLEPLUS_OPEN)
...
#ifdef CONFIG_MSM_BACKGROUND_CHARGING
#define BATT_BACK_FULL_CHARGING_CURRENT 	130
#define BATT_BACK_MAX_CHARGING_TIME		(30 * TIME_UNIT_MINUTE)
#endif
#define BATT_FULL_CHARGING_VOLTAGE	4000
#define BATT_RECHARGING_VOLTAGE_1		4290
#define BATT_RECHARGING_VOLTAGE_2		4140
...
static struct device_attribute msm_battery_attrs[] = {
	...
	MSM_BATTERY_ATTR(batt_at_batttest),
#endif
};
...
static u32 get_level_from_fuelgauge(void)
{
	...
	#ifdef CONFIG_MACH_ARUBA_DUOS_CTC
			return bq27425_get_soc();			
	#else
			return bq27425_get_calc_soc();
	#endif
	}
#else
	if (is_attached)
...
static int msm_batt_check_level(int battery_level)
{
	...
	battery_level = ((battery_level * 10000) / ((msm_batt_info.charger_detached_fullsoc - 1) * 100));
