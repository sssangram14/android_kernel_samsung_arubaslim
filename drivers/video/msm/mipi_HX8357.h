...
#define HX8357_CMD_DELAY_40MS	40
#define HX8357_SETTING_GAMMA 1
#define HX8357_SLEEP_IN_DELAY_100MS 100
...
static struct dsi_cmd_desc hx8357_display_off_cmds[] = {
	{DTYPE_DCS_WRITE, 1, 0, 0, HX8357_CMD_DELAY_40MS,sizeof(hx8357_display_off), hx8357_display_off},
	{DTYPE_DCS_WRITE, 1, 0, 0, HX8357_SLEEP_IN_DELAY_100MS, sizeof(hx8357_enter_sleep), hx8357_enter_sleep},
	{DTYPE_GEN_LWRITE, 1, 0, 0, HX8357_CMD_SETTLE, sizeof(hx8357_internal_osc), hx8357_internal_osc}
};
