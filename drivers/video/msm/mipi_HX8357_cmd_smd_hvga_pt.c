...
static char hx8357d_boe_video_02[] = {
 0xB1,
 	0x00,0x14,0x15,0x15,0xC6,0x21,0x29
};
...
static char hx8357d_boe_video_04[] = {
 0xB4,
 	0x00,0x40,0x00,0x2A,0x2A,0x01,0x48
};
...
static char hx8357d_boe_video_11[] = {
 0xE0,
 	0x00,0x04,0x0E,0x1C,0x28,0x3F,0x4B,0x54,0x45,0x3F,
 	0x3A,0x32,0x2F,0x2A,0x25,0x01,0x04,0x04,0x0E,0x1B,
 	0x27,0x3F,0x4B,0x54,0x45,0x40,0x39,0x31,0x2E,0x29,
 	0x24,0x01,0x00,0x01
};
...
static char hx8357d_boe_video_15[] = {
 0x29,
 	0x00
};
...
static struct dsi_cmd_desc hx8357_boe_cmd_prepare_panel[] = {
	{DTYPE_GEN_LWRITE, 1, 0, 0, HX8357_SETTING_SETTLE,	sizeof(hx8357d_boe_video_01), hx8357d_boe_video_01},
	{DTYPE_GEN_LWRITE, 1, 0, 0, HX8357_CMD_SETTLE,		sizeof(hx8357d_boe_video_02), hx8357d_boe_video_02},
	{DTYPE_GEN_LWRITE, 1, 0, 0, HX8357_CMD_SETTLE,		sizeof(hx8357d_boe_video_03), hx8357d_boe_video_03},
	...
	{DTYPE_GEN_LWRITE, 1, 0, 0, HX8357_SETTING_GAMMA,	sizeof(hx8357d_boe_video_11), hx8357d_boe_video_11},
	{DTYPE_GEN_LWRITE, 1, 0, 0, HX8357_CMD_SETTLE,		sizeof(hx8357d_boe_video_12), hx8357d_boe_video_12},
	{DTYPE_GEN_LWRITE, 1, 0, 0, HX8357_CMD_SETTLE,		sizeof(hx8357d_boe_video_13), hx8357d_boe_video_13},
	{DTYPE_DCS_WRITE,  1, 0, 0, HX8357_SLEEP_OUT_DELAY, sizeof(hx8357d_boe_video_14), hx8357d_boe_video_14},
	{DTYPE_DCS_WRITE,  1, 0, 0, HX8357_HOLD_RESET,		sizeof(hx8357d_boe_video_15), hx8357d_boe_video_15},
};
