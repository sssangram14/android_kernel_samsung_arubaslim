...
static int sr300pc20_sensor_read(unsigned short subaddr, unsigned short *data)
{
	int ret = 0;
...
static int sr300pc20_sensor_write(unsigned short subaddr, unsigned short val)
{
...
static int sr300pc20_sensor_write_list(const unsigned int *list, int size,
				      char *name)
{
	int ret = 0, i;
...
static int sr300pc20_sensor_burst_write(const unsigned int *list, int size,
				       char *name)
{
	int err = -EINVAL;
	int i = 0;
...
static int sr300pc20_get_exif(int exif_cmd, unsigned short value2)
{
